import { Box, Divider, HStack, SimpleGrid, StackDivider, VStack, Text, Button, Image, Icon, Checkbox, Circle, useDisclosure, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, ModalFooter,  FormControl,
  FormLabel,
  FormErrorMessage,
  FormHelperText,
  Input,
...
import SingleWishlistProduct from '../Components/SingleSimilarProduct'
...
<Center>
  <VStack>
    ...
    <Button onClick={()=>navigate("/wishlist")} colorScheme={"pink"} variant="outline" borderRadius={"2px"}>ADD ITEM FROM WISHLIST</Button>
  </VStack>
</Center>
